...
tg_post_msg "<b> Build Started on Cirrus CI</b>%0A<b>Branch: </b><code>$GITBRNCH</code>%0A<b>Build Number: </b><code>"$BUILD_NUMBER"</code>%0A<b>Date : </b><code>$(TZ=Etc/UTC date)</code>%0A<b>Top Commit : </b><code>$COMMIT_HEAD</code>%0A"
